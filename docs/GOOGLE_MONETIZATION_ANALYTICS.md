...
After the visitor's consent choice permits analytics storage, Callout sends SPA page views and product events for login, signup, posts, guild creation, Takes, and Based/Hot Take ranking.
