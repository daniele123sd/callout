...
function openPostMenu(id) {
  ...
  tts.type = 'button'; tts.dataset.ttsPost = ''; tts.innerHTML = '<span>◉</span><span><strong>Text to Speech</strong><small>Generate an MP3 voiceover for this take</small></span>';
