...
export const BOT_PERSONAS = [
  ...
  },
  {
    ...
    comments: ['I disagree, but this is a fair line to draw.', 'The context changes this one more than people admit.', 'This deserves a proper Based versus Hot Take split.']
  }
];
